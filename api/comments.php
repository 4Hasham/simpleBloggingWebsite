...
<?php
    ...
    function printComment($con, $id, $indent) {
        ...
        echo ("
        <table style=\"padding: 3px; background: #e5e5e5; margin-left: ".$indent."px; display: inline-block;\">
            <tr>
                <td style=\"padding: 5px;\"><img src=\"".$row1['dp']."\" width=\"40\" height=\"40\" />&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"profile.php?id=".$row1['ID']."\">".$row1['name']."</a></td>
                <td colspan=\"2\" style=\"text-align:right;\">".$row['date']."</td>
            </tr>
            <tr>
                <td style=\"padding-top: 16px; padding-bottom: 8px;\" colspan=\"2\">".$row['content']."</td>
            </tr>
            <tr>
                <td><textarea id=\"edit".$row['ID']."\" class=\"form-control\" placeholder=\"Reply\"></textarea></td>
    ...
    function collectIDs($con, $oid, $indent) {
        ...
        if(mysqli_num_rows($sql) > 0) {
            while($row = mysqli_fetch_array($sql)) {
                ...
                $ret = collectIDs($con, $row['ID'], $indent + 20);
            }
        }
        return $ret;
    }
